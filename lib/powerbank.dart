  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Oneplus', 'Samsung','Redmi','Syska'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('OSBS', 'assets/bulbul/2000.jpg', 4.8, 236, 2000,),
    Product('Oneplus', 'assets/bulbul/bank.jpg', 4.7, 59, 2500),
    Product('Syska', 'assets/bulbul/pb.png', 5.0, 29, 1500),
    Product('Samsung', 'assets/bulbul/sp.png', 4.8, 163, 3500),
    Product('Redmi', 'assets/bulbul/redpb.png', 4.8, 163, 799),
    Product('Bell', 'assets/bulbul/bell.png', 4.8, 163, 899),
  ];
