  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Fortune', 'Aashirvad','TATA'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Ashirwad Atta', 'assets/rakshita/pr1.jfif', 4.8, 566, 169.00,),
    Product('Fortune Oil', 'assets/rakshita/pr2.jfif', 4.7, 59, 677.00),
    Product('Fresh Ghee', 'assets/rakshita/pr3.jfif', 5.0, 29, 300.00),
    Product('TATA Salt', 'assets/rakshita/pr4.jpg', 4.8, 163, 500.00),
    Product('India Gate Rice', 'assets/rakshita/pr5.jfif', 4.7, 59, 187.00),
    Product('Jeera', 'assets/rakshita/images.jfif', 4.7, 59, 987.00),
    Product('Dal Masalaa', 'assets/rakshita/f1.jpg', 4.7, 59, 587.00),
  ];
