...
class Ayur extends StatefulWidget {
  @override
  State<Ayur> createState() => _AyurState();
}

class _AyurState extends State<Ayur> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Vicco', 'Dabur','Zandu'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('DR VAIDYA DIABEX\n-30 CAPSULES', 'assets/images/ayur1.jpg', 4.8, 236, 394.89,),
    Product('Planet Ayurveda Dia\nBeta Plus Capsules', 'assets/images/ayur2.jpg', 4.7, 59, 1350),
    Product('Himalaya Arjuna Capsules', 'assets/images/ayur3.jpg', 5.0, 29, 190),
    Product('Himalaya Purifying Neem Face Wash', 'assets/images/ayur4.jpg', 4.8, 163, 404),
    Product('Buy Patanjali Kesh Kanti Hair Oil', 'assets/images/ayur5.jpg', 4.8, 163, 357.33),
    Product('Dr Vaidya My Prash Chyawanprash ', 'assets/images/ayur6.jpg', 4.8, 163, 874.12),
  ];
  @override
  Widget build(BuildContext context) {
