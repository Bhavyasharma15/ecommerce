...
class MB extends StatefulWidget {
  @override
  State<MB> createState() => _MBState();
}

class _MBState extends State<MB> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Nivea', 'Johnson','Dove'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Nivea Baby Soft\n& Cream Wipes ', 'assets/images/mb1.jpg', 4.8, 236, 169.00,),
    Product('The derma ', 'assets/images/mb2.jpg', 4.7, 59, 187.00),
    Product('Loose Fit Hoodie', 'assets/images/mb3.jpg', 5.0, 29, 0.00),
    Product('DryMove™ Track', 'assets/images/mb4jpg.jpg', 4.8, 163, 0.00),
  ];
