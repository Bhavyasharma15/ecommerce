  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Samsung', 'Ipad','Oneplus','huawei','Redmi'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Huawei', 'assets/bulbul/huawei.jpg', 4.8, 236, 50000,),
    Product('Ipad', 'assets/bulbul/ipad.jpg', 4.7, 59,100000 ),
    Product('Ipad Pro', 'assets/bulbul/pro.jpg', 5.0, 29, 150000),
    Product('Samsung', 'assets/bulbul/tab.jpg', 4.8, 163, 100000),
    Product('Redmi', 'assets/bulbul/tablet.jpg', 4.8, 163, 35000),
    Product('Oneplus', 'assets/bulbul/one.jpg', 4.8, 163, 70000),
  ];
