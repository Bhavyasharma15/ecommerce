  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Samsung', 'Boat','Airpods','JBL',''].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Airpods', 'assets/bulbul/airpods.jpg', 4.8, 236, 10000,),
    Product('Samsung buds', 'assets/bulbul/buds.jpg', 4.7, 200, 25000),
    Product('Boat', 'assets/bulbul/head.jpg', 5.0, 100, 1500),
    Product('JBL', 'assets/bulbul/jbl.jpg', 4.8, 163, 2500),
    Product('Samsung Buds', 'assets/bulbul/sbuds.jpg', 4.8, 163, 23000),
    Product('Airpods', 'assets/bulbul/air.jpg', 4.8, 120, 15000),
  ];
