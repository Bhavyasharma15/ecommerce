  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _color,
          items: <String>['Color', 'Black', 'White', 'Yellow'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Adidas', 'DSC', 'Puma'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('DSC Jaffa 22 Cricket Shoes', 'assets/sakshi/shoes1.jpg', 4.8, 236, 3300,),
    Product('Puma Synthetic Puma Roma Basic', 'assets/sakshi/shoes2.jpg', 4.7, 59, 5000),
    Product('Fier NITRO', 'assets/sakshi/shoes3.jpg', 5.0, 29, 3999),
    Product('Adidas mens Crinu Sneaker', 'assets/sakshi/shoes4.jpg', 4.8, 163, 7999),
    Product('Adidas Cartagena Football Boots', 'assets/sakshi/shoes5.jpg', 4.8, 163, 12000),
    Product(' Adidas Sports Shoes', 'assets/sakshi/shoes6.jpg', 4.8, 163, 15000),
    Product('Puma Shoes', 'assets/sakshi/shoes7.jpg', 4.8, 163, 22000),
