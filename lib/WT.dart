  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'BIBA', 'H&M'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('White Kurta Pant with printed Bule Duptta', 'assets/himanshi/kurtaaaa.jpg', 4.8, 236, 469.00),
    Product('Printed Cotton Lehnga', 'assets/himanshi/leh.avif', 4.7, 59, 550.00),
    Product('Beautifully Shaded Saree', 'assets/himanshi/saaree.jpg', 5.0, 29, 400.00), // Assuming free for demonstration
    Product('Pretty Lehnga with sequence Blouse', 'assets/himanshi/sea.jpeg', 4.8, 163, 600.00),
    Product('Cotton Wedding Wear Printed Suit', 'assets/himanshi/set.jpg', 4.8, 163, 850.00),
    Product('Black Pretty Suit with golden print', 'assets/himanshi/we.jpeg', 4.8, 163, 900.00)
  ];
