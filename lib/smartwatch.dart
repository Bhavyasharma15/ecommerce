  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Samsung', 'Iwatch','Boat','Noise',''].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Iwatch', 'assets/bulbul/iwatch.jpg', 4.8, 236, 30000,),
    Product('Samsung', 'assets/bulbul/sw.jpg', 4.7, 59, 35000),
    Product('Boat', 'assets/bulbul/boat.jpg', 5.0, 29, 4000),
    Product('Noise', 'assets/bulbul/noise.jpg', 4.8, 163, 2500),
    Product('Samsung', 'assets/bulbul/smartwatch.jpg', 4.8, 163, 30000),
    Product('Iwatch', 'assets/bulbul/watch.jpg', 4.8, 163, 35000),
  ];
