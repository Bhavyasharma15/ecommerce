  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'ONIDA', 'PANASONIC','VOLTAS','MARQ'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Onida 5-in-1', 'assets/gunjan/ac1.jpg', 4.8, 6, 28990.00,),
    Product('Gree 7 in 1', 'assets/gunjan/ac2.jpg', 4.7, 9, 36990.00),
    Product('Active 5-in-1', 'assets/gunjan/ac3.jpg', 5.0, 2, 22990.00),
    Product('Godrej 5-in-1', 'assets/gunjan/ac4.jpg', 4.8, 3, 49790.00),
  ];
