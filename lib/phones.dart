  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Iphone', 'Samsung','Redmi','Realme','Oneplus'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Iphone ', 'assets/bulbul/apple.jpg', 4.8, 236, 50000,),
    Product('Samsung Galaxy Fold', 'assets/bulbul/samsung.jpg', 4.7, 59, 100000),
    Product('oneplus', 'assets/bulbul/images.jpg', 5.0, 29, 40000),
    Product('Realme', 'assets/bulbul/realme.jpg', 4.8, 163, 10000),
    Product('Redmi', 'assets/bulbul/redmi.png', 4.8, 163, 17000),
    Product('Samsung Flip', 'assets/bulbul/sam.jpg', 4.8, 163, 200000),
  ];
