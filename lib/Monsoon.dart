  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Otrivin', 'Cofsils',].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Cetaphil\nGentile Skin Cleanser', 'assets/images/Monsoon1.jpg', 4.8, 236, 169.00,),
    Product('The derma', 'assets/images/monsoon2.jpg', 4.7, 59, 187.00),
    Product('Loose Fit Hoodie', 'assets/images/monsoon3.jpeg', 5.0, 29, 0.00),
    Product('DryMove™ Track', 'assets/images/monsoon4.jpg', 4.8, 163, 0.00),
  ];
