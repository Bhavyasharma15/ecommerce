  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'HP', 'DELL','Macbook','Aser','Asus'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Macbook Pro ', 'assets/bulbul/macbook.jpg', 4.8, 236, 150000,),
    Product('Macbook', 'assets/bulbul/mac.jpg', 4.7, 59, 100000),
    Product('Asus', 'assets/bulbul/asus.jpg', 5.0, 29, 700000),
    Product('Dell', 'assets/bulbul/dell.jpg', 4.8, 163, 50000),
    Product('Aser', 'assets/bulbul/aser.jpg', 4.8, 163, 50000),
    Product('HP', 'assets/bulbul/hp.jpg', 4.8, 163, 670000),
  ];
