  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'VOLTAS', 'MIDEA','BOSCH'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Voltas Beko DT85', 'assets/gunjan/dishwasher3.jpeg', 4.8, 6, 16990.00,),
    Product('Midea WQP12', 'assets/gunjan/dishwasher2.jpeg', 4.7, 9, 22990.00),
    Product('Bosch SMS66GI01', 'assets/gunjan/dishwasher1.jpeg', 5.0, 9, 45600.00),
   ];
