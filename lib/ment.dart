...
class ment extends StatefulWidget {
  @override
  State<ment> createState() => _mentState();
}

class _mentState extends State<ment> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'H&M', 'Jompers'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('White Kurta Pajama with Blue koty', 'assets/himanshi/coty.jpg', 4.8, 236, 899.00),
    Product('Casual Kurta For boys', 'assets/himanshi/pkurta.avif', 4.7, 59, 280.00),
    Product('Ethnic Wedding Wear ', 'assets/himanshi/indo.jpg', 5.0, 29, 1100.00), // Assuming free for demonstration
    Product('Pink Kurta pajama with printed Koty', 'assets/himanshi/koty.jpg', 4.8, 163, 800.00),
    Product('Trendy Kurta With Sequence work', 'assets/himanshi/kurrtaa.jpg', 4.8, 163, 300.00),
    Product('Kurta Dhoti For Boys ', 'assets/himanshi/kurta.jpeg', 4.8, 163, 550.00)
  ];
