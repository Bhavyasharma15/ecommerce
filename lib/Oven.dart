  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _color,
          items: <String>['Color', 'Black', 'White','Maroon'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'IFB', 'HAIER','iBELL','FABER','AGARO'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('iBell 19L', 'assets/gunjan/oven1.jpg', 4.8, 6, 2759.00,),
    Product('Faber 20L', 'assets/gunjan/oven2.jpg', 4.7, 9, 4890.00),
    Product('Agaro 40L', 'assets/gunjan/oven3.jpg', 5.0, 2, 6929.00),
     Product('Haier 19L', 'assets/gunjan/oven.jpg', 4.8, 3, 4990.00),
  ];
