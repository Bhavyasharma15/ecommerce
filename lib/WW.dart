...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product(' Casual womens wear', 'assets/himanshi/dress.jpg', 4.8, 236, 359.00),
    Product('Short Blue Dungry', 'assets/himanshi/dung.jpg', 4.7, 59, 297.00),
    Product('Tuwel Grey bagy jeans', 'assets/himanshi/jeans.jpg', 5.0, 29, 700.00), // Assuming free for demonstration
    Product('Black Bodycone Dress', 'assets/himanshi/cone.jpg', 4.8, 163, 300.00),
    Product('Orange crop Shirt', 'assets/himanshi/sh.jpg', 4.8, 163, 250.00),
    Product('Printed Short Dress', 'assets/himanshi/short.jpg', 4.8, 163, 300.00)
  ];
