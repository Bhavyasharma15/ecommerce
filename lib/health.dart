  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _color,
          items: <String>['Types', 'Whey', 'Nutrela'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Fytika', 'Atom','GNC'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Balanced Nutrition Powder', 'assets/sakshi/health1.jpeg', 4.8, 236, 1200),
    Product('Livestamin Whey Protein', 'assets/sakshi/health2.jpeg', 4.7, 59,5400),
    Product('Nutrela Isoveda Whey Protein', 'assets/sakshi/health3.jpg', 5.0, 29, 2025),
    Product('Fytika Daily Protein Powder', 'assets/sakshi/health4.jpg', 4.8, 163, 899),
    Product('Whey Protein, Chocolate', 'assets/sakshi/health5.png', 4.8, 163, 5899),
    Product('Applied Nutrition Diet Whey', 'assets/sakshi/health6.jpg', 4.8, 163, 3699),
  ];
