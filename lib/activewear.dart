...
class  Activewear extends StatefulWidget {
  @override
  State<Activewear> createState() => _ActivewearState();
}
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'Adidas', 'Puma'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('India Cricket Odi Jersey', 'assets/sakshi/cloth1.png', 4.8, 236, 5500),
    Product('Ro Sports jersey', 'assets/sakshi/cloth2.jpg', 4.7, 59,7000),
    Product('IND T20 Cricket Jersey', 'assets/sakshi/cloth3.jpg', 5.0, 29, 6666),
    Product('T-Shirt for Football', 'assets/sakshi/cloth4.jpeg', 4.8, 163, 2200),
    Product('Youth Soccer Shirt ', 'assets/sakshi/cloth5.jpeg', 4.8, 163, 4400),
    Product('Pogba Football Jersey ', 'assets/sakshi/cloth6.jpg', 4.8, 163, 9999),
    Product(' Real Madrid Training Shirt', 'assets/sakshi/cloth7.jpeg', 4.8, 163, 2900),
