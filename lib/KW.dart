...
class KW extends StatefulWidget {
  @override
  State<KW> createState() => _KWState();
}

class _KWState extends State<KW> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'prada', 'gucci'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('party Wear suit for boys', 'assets/himanshi/party.jpg', 4.8, 236, 499.00),
    Product('Casual dress for girls', 'assets/himanshi/kw.jpg', 4.7, 59, 200.00),
    Product('Cute Tiger Printed Sweattshirt ', 'assets/himanshi/images.jpeg', 5.0, 29, 349.00), // Assuming free for demonstration
    Product('Cute Mini SkirtTopper for girls', 'assets/himanshi/dd.jpg', 4.8, 163, 380.00),
    Product('Pink Dungry For Girls', 'assets/himanshi/dungr.jpg', 4.8, 163, 470.00),
    Product('Casual Capri tshirt For Boys', 'assets/himanshi/KD.jpg', 4.8, 163, 350.00)
