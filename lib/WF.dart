...
class WF extends StatefulWidget {
  @override
  State<WF> createState() => _WFState();
}

class _WFState extends State<WF> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand', 'ADDIDAS', 'BATA'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Stylish Fancy Heel Sandal ', 'assets/himanshi/wf.jpg', 4.8, 236, 169.00),
    Product('medifeet  footwear ', 'assets/himanshi/wff.jpg', 4.7, 59, 187.00),
    Product('BK Deal flats sandals |', 'assets/himanshi/wfff.jpg', 5.0, 29, 0.00), // Assuming free for demonstration
    Product('Pointed pumps', 'assets/himanshi/wffff.jpg', 4.8, 163, 0.00),
    Product('White casual sneakers', 'assets/himanshi/shoooooooooo.jpg', 4.8, 163, 0.00),
    Product(' Pointed-Toe Ankle-Length Boots', 'assets/himanshi/wfffff.jpeg', 4.8, 163, 0.00)
